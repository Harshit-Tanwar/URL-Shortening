...
const UserUrl = () => {
  ...
  const handleCopy = (url , id) => {
    ...
    setcopiedId(id);
    // Clear the copiedId after 2 seconds
    setTimeout(() => {
      setcopiedId(null);
    }, 2000);
  ...
  return (
    <div className=" rounded-lg mt-5 shadow-md  overflow-hidden">
      <div className="overflow-x-auto h-56">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-zinc-50">
            <tr>
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-zinc-700 uppercase tracking-wider">
                Original URL
              </th>
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-zinc-700 uppercase tracking-wider">
                Short URL
